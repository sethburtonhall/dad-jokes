...
<template>
  ...
  <div class="px-6 py-12 bg-gray-900 lg:p-24 dark:bg-gray-200">
    <div class="flex items-center justify-between w-full">
      ...
      <span class="invisible text-white cursor-pointer lg:visible" @click="toggleFirePit">Warm up by the <span class="text-3xl">🔥</span></span>
    ...
    <div class="flex flex-col justify-between space-y-4 md:space-y-0 md:space-x-4 md:flex-row image">
      <div class="md:w-1/3">
        <img src="../assets/farside1.jpg" alt="The Far Side image" />
      ...
      <div class="md:w-1/3">
        <img src="../assets/han-leno.jpg" alt="Han Leno meme" />
      </div>

      <img src="../assets/west.jpg" alt="wild west meme" class="md:w-1/3" />
    </div>
  </div>
  ...
  <div class="px-6 py-12 bg-blue-500 lg:p-24">
    ...
    <div class="flex flex-col justify-between space-y-4 md:flex-row md:space-y-0 md:space-x-4 image-alt">
      ...
      <div class="md:w-1/3">
        <img src="../assets/joke2.jpg" alt="Dad Jokes: Hall of Shame" />
      </div>
      <div class="md:w-1/3">
        <img src="../assets/joke3.jpg" alt="Dad Jokes: Hall of Shame" />
      </div>
    </div>
...
<style scoped>
  .header {
  @apply mb-4 text-3xl md:text-4xl font-display
  }
  .image img {
    @apply border-4 dark:border-gray-900 border-white
  }
